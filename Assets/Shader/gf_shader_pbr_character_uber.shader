Shader "gf_shader/pbr/character/uber" {
	Properties {
		...
		[Toggle(_USE_SSS)] _UseSubsurfaceScattering ("Use Subsurface Scattering", Float) = 0
		[HiddenByKeyword(_USE_SSS)] _SSSIntensity ("Subsurface Scattering Thickness", Range(0, 1)) = 0.5
